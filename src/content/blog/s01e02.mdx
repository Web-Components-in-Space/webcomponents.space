---
pubDatetime: 2022-05-10T15:00:00
...
tags:
  ...
  - typescript
  - season 1
description: Ben chats with Merl about his shader-doodle project and we build an application that exports shaders as GIFs
---
...
<ul class="episode-list">
    <li>
        <h2>
              <LinkButton
                target="_blank"
                href="https://www.youtube.com/playlist?list=PLtQN1dImn5UXPjZtpsFJhCtbB2jFiBtiU"
                className="link-button"
                title={"Watch all of Episode 2"}
              >
                <Fragment set:html={socialIcons['YouTube']} />
              </LinkButton>
              <span> Episode 2: </span>
        </h2>
        <strong>Watch all of Episode 2</strong>
        <p>
    ...
    <li>
        <h2>
              <LinkButton
                target="_blank"
                href="https://www.youtube.com/watch?v=BiOCZyk9RBs&list=PLtQN1dImn5UXPjZtpsFJhCtbB2jFiBtiU&index=2"
                className="link-button"
                title={"Run-down"}
              >
                <Fragment set:html={socialIcons['YouTube']} />
              </LinkButton>
              <span> Episode 2.1:</span>
        </h2>
    ...
    <li>
        <h2>
              <LinkButton
                target="_blank"
                href="https://www.youtube.com/watch?v=fuq4eHR67bI&list=PLtQN1dImn5UXPjZtpsFJhCtbB2jFiBtiU&index=3"
                className="link-button"
                title={"Show &amp; Tell"}
              >
                <Fragment set:html={socialIcons['YouTube']} />
              </LinkButton>
              <span> Episode 2.2:</span>
        </h2>
    ...
    <li>
        <h2>
              <LinkButton
                target="_blank"
                href="https://www.youtube.com/watch?v=gJ122qmTgqc&list=PLtQN1dImn5UXPjZtpsFJhCtbB2jFiBtiU&index=4"
                className="link-button"
                title={"Interview with Merl"}
              >
                <Fragment set:html={socialIcons['YouTube']} />
              </LinkButton>
              <span> Episode 2.3:</span>
        </h2>
        <strong>Interview with Merl</strong>
        <p>
    ...
    <li>
        <h2>
            <LinkButton
                target="_blank"
                href="https://www.youtube.com/watch?v=a0XLwdv9BRA&list=PLtQN1dImn5UXPjZtpsFJhCtbB2jFiBtiU&index=5"
                className="link-button"
            ...
            <LinkButton
                target="_blank"
                href="https://github.com/Web-Components-in-Space/S01E02-ShaderDoodle/tree/step1"
                className="link-button"
                title={"Step 1 Code"}
              >
                <Fragment set:html={socialIcons['Github']} />
            </LinkButton>
            <span> Episode 2.4:</span>
        </h2>
    ...
    <li>
        <h2>
            <LinkButton
                target="_blank"
                href="https://www.youtube.com/watch?v=-Kgq2lk7-kI&list=PLtQN1dImn5UXPjZtpsFJhCtbB2jFiBtiU&index=6"
                className="link-button"
                title={"Lab Step 2 - Add the UI"}
                >
                <Fragment set:html={socialIcons['YouTube']} />
            </LinkButton>
            <LinkButton
                target="_blank"
                href="https://github.com/Web-Components-in-Space/S01E02-ShaderDoodle/tree/step2"
                className="link-button"
                title={"Step 2 Code"}
              >
                <Fragment set:html={socialIcons['Github']} />
            </LinkButton>
            <span> Episode 2.5:</span>
        </h2>
        <strong>Lab Step 2 - Add the UI</strong>
        <p>
    ...
    <li>
       <h2>
            <LinkButton
                target="_blank"
                href="https://www.youtube.com/watch?v=sbbAlbGrNbs&list=PLtQN1dImn5UXPjZtpsFJhCtbB2jFiBtiU&index=7"
                className="link-button"
                title={"Lab Step 3 - Add Shader Doodle (and code editor)"}
                >
                <Fragment set:html={socialIcons['YouTube']} />
            </LinkButton>
            <LinkButton
                target="_blank"
                href="https://github.com/Web-Components-in-Space/S01E02-ShaderDoodle/tree/step3"
                className="link-button"
                title={"Step 3 Code"}
              >
                <Fragment set:html={socialIcons['Github']} />
            </LinkButton>
            <span> Episode 2.6:</span>
        </h2>
        <strong>Lab Step 3 - Add Shader Doodle (and code editor)</strong>
        <p>
    ...
    <li>
       <h2>
            <LinkButton
                target="_blank"
                href="https://www.youtube.com/watch?v=_iT251jW_O0&list=PLtQN1dImn5UXPjZtpsFJhCtbB2jFiBtiU&index=8"
                className="link-button"
                title={"Lab Step 4 - Wire up the UI"}
                >
                <Fragment set:html={socialIcons['YouTube']} />
            </LinkButton>
            <LinkButton
                target="_blank"
                href="https://github.com/Web-Components-in-Space/S01E02-ShaderDoodle/tree/step4"
                className="link-button"
                title={"Step 4 Code"}
              >
                <Fragment set:html={socialIcons['Github']} />
            </LinkButton>
            <span> Episode 2.7:</span>
        </h2>
        <strong>Lab Step 4 - Wire up the UI</strong>
        <p>
    ...
    <li>
       <h2>
            <LinkButton
                target="_blank"
                href="https://www.youtube.com/watch?v=td7Xeagd3FE&list=PLtQN1dImn5UXPjZtpsFJhCtbB2jFiBtiU&index=9"
                className="link-button"
                title={"Lab Step 5 - Editing the Shader"}
                >
                <Fragment set:html={socialIcons['YouTube']} />
            </LinkButton>
            <LinkButton
                target="_blank"
                href="https://github.com/Web-Components-in-Space/S01E02-ShaderDoodle/tree/step5"
                className="link-button"
                title={"Step 4 Code"}
              >
                <Fragment set:html={socialIcons['Github']} />
            </LinkButton>
            <span> Episode 2.8:</span>
        </h2>
        <strong>Lab Step 5 - Editing the Shader</strong>
        <p>
    ...
    <li>
       <h2>
            <LinkButton
                target="_blank"
                href="https://www.youtube.com/watch?v=X-_k54GmxI0&list=PLtQN1dImn5UXPjZtpsFJhCtbB2jFiBtiU&index=10"
                className="link-button"
                title={"Lab Step 6 - Rendering the GIF"}
                >
                <Fragment set:html={socialIcons['YouTube']} />
            </LinkButton>
            <LinkButton
                target="_blank"
                href="https://github.com/Web-Components-in-Space/S01E02-ShaderDoodle/tree/step6"
                className="link-button"
                title={"Step 6 Code"}
              >
                <Fragment set:html={socialIcons['Github']} />
            </LinkButton>
            <span> Episode 2.9:</span>
        </h2>
        <strong>Lab Step 6 - Rendering the GIF</strong>
        <p>
    ...
    <li>
       <h2>
            <LinkButton
                target="_blank"
                href="https://www.youtube.com/watch?v=XV6mqQjFeH8&list=PLtQN1dImn5UXPjZtpsFJhCtbB2jFiBtiU&index=11"
                className="link-button"
                title={"Lab Step 7 - Bundle and Build with Rollup"}
                >
                <Fragment set:html={socialIcons['YouTube']} />
            </LinkButton>
            <LinkButton
                target="_blank"
                href="https://github.com/Web-Components-in-Space/S01E02-ShaderDoodle/tree/step7"
                className="link-button"
                title={"Step 7 Code"}
              >
                <Fragment set:html={socialIcons['Github']} />
            </LinkButton>
            <span> Episode 2.10:</span>
        </h2>
        <strong>Lab Step 7 - Bundle and Build with Rollup</strong>
        <p>
