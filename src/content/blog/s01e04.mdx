...
tags:
  ...
  - design system
  - season 1
description: In this episode we chat with Cassondra Roberts about Web Component style, make some web music demos, and then integrate them into an application
---
...
<ul class="episode-list">
    <li>
        <h2>
              <LinkButton
                target="_blank"
                href="https://www.youtube.com/playlist?list=PLtQN1dImn5UWuvaGYFdxMDrD2vDn9quEJ"
                className="link-button"
                title={"Watch all of Episode 4"}
              >
                <Fragment set:html={socialIcons['YouTube']} />
              </LinkButton>
              <span> Episode 4:</span>
        </h2>
        <strong>Watch all of Episode 4</strong>
        <p>
    ...
    <li>
        <h2>
              <LinkButton
                target="_blank"
                href="https://youtu.be/92jLAcYtcOU"
                className="link-button"
                title={"Run-down"}
              >
                <Fragment set:html={socialIcons['YouTube']} />
              </LinkButton>
              <span> Episode 4.1:</span>
        </h2>
    ...
    <li>
        <h2>
              <LinkButton
                target="_blank"
                href="https://youtu.be/5jpJ0h54Sb0"
                className="link-button"
                title={"Show &amp; Tell"}
              >
                <Fragment set:html={socialIcons['YouTube']} />
              </LinkButton>
              <span> Episode 4.2:</span>
        </h2>
    ...
    <li>
        <h2>
              <LinkButton
                target="_blank"
                href="https://youtu.be/7n3PHEx_xvg"
                className="link-button"
                title={"Interview with Cassondra Roberts"}
              >
                <Fragment set:html={socialIcons['YouTube']} />
              </LinkButton>
              <span> Episode 4.3:</span>
        </h2>
        <strong>Interview with Cassondra Roberts</strong>
        <p>
    ...
    <li>
        <h2>
              <LinkButton
                target="_blank"
                href="https://youtu.be/_OMaIIdz9Gg"
                className="link-button"
                title={"Lab Step 1 - Web MIDI"}
              >
                <Fragment set:html={socialIcons['YouTube']} />
              </LinkButton>
              <LinkButton
                  target="_blank"
                  href="https://github.com/Web-Components-in-Space/S01E04-AudioDemos"
                  className="link-button"
                  title={"Demo Code"}
                >
                  <Fragment set:html={socialIcons['Github']} />
              </LinkButton>
              <span> Episode 4.4:</span>
        </h2>
        <strong>Lab Step 1 - Web MIDI</strong>
        <p>
    ...
    <li>
        <h2>
          <LinkButton
                target="_blank"
                href="https://youtu.be/jkfTvACeCuU"
                className="link-button"
                title={"Lab Step 2 - Pitch Detection"}
              >
                <Fragment set:html={socialIcons['YouTube']} />
              </LinkButton>
              <LinkButton
              ...
              <span> Episode 4.5:</span>
        </h2>
        <strong>Lab Step 2 - Pitch Detection</strong>
        <p>
    ...
    <li>
        <h2>
          <LinkButton
            target="_blank"
            href="https://youtu.be/eRZ_Sp4PRPU"
            className="link-button"
            title={"Lab Step 3 - Playing sounds with Tone.js"}
          >
            <Fragment set:html={socialIcons['YouTube']} />
          </LinkButton>
          <LinkButton
          ...
          <span> Episode 4.6:</span>
        </h2>
        <strong>Lab Step 3 - Playing sounds with Tone.js</strong>
        <p>
    ...
    <li>
        <h2>
          <LinkButton
            target="_blank"
            href="https://youtu.be/sPL5as_ckqc"
            className="link-button"
            title={"Lab Step 4 - Lit Reactive Controllers"}
          >
            <Fragment set:html={socialIcons['YouTube']} />
          </LinkButton>
          <LinkButton
          ...
          <span> Episode 4.7:</span>
        </h2>
        <strong>Lab Step 4 - Lit Reactive Controllers</strong>
        <p>
    ...
    <li>
        <h2>
          <LinkButton
            target="_blank"
            href="https://youtu.be/EH5PjMHIEfY"
            className="link-button"
            title={"Lab Step 5 - Styling Web Components and a Mini Design System"}
          >
            <Fragment set:html={socialIcons['YouTube']} />
          </LinkButton>
          <LinkButton
              target="_blank"
              href="https://github.com/Web-Components-in-Space/S01E04-BeSharp/tree/pre-integration"
              className="link-button"
              title={"BeSharp Music App"}
            >
              <Fragment set:html={socialIcons['Github']} />
          </LinkButton>
          <span> Episode 4.8:</span>
        </h2>
        <strong>Lab Step 5 - Styling Web Components and a Mini Design System</strong>
        <p>
